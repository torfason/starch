...
which is XXH128 rather than md5 and is by a wide margin the fastest of
the file hashers available. The hash value is not the point - only
whether it changed - so the algorithm is free to change, at the cost of
