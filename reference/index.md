...
- [`qs_render_activities()`](https://torfason.github.io/starch/reference/qs_render_activities.md)
...
- [`qs_render_heatmap()`](https://torfason.github.io/starch/reference/qs_render_heatmap.md)
  : Render the route heat map
- [`qs_render_index()`](https://torfason.github.io/starch/reference/qs_render_index.md)
  : Render the dashboard navigation index
- [`qs_render_list()`](https://torfason.github.io/starch/reference/qs_render_list.md)
  : Render the plain activity list
- [`qs_render_table()`](https://torfason.github.io/starch/reference/qs_render_table.md)
  : Render the filterable activity table
- [`qs_view_dashboard()`](https://torfason.github.io/starch/reference/qs_view_dashboard.md)
